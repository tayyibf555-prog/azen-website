...
export default function CaseStudyDetail() {
    ...
    if (!caseStudy) {
        return (
            <div className="min-h-screen bg-[#020817] text-white selection:bg-cyan-500/30 flex items-center justify-center">
    ...
    return (
        <div className="min-h-screen text-white bg-[#020817] relative overflow-hidden font-sans">
