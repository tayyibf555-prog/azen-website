...
export default function CaseStudyDetail() {
    ...
    if (!caseStudy) {
        return (
            <div className="min-h-screen bg-gradient-to-tr from-black to-blue-900 text-white selection:bg-cyan-500/30 flex items-center justify-center">
    ...
    return (
        <div className="min-h-screen text-white bg-gradient-to-tr from-black to-blue-900 relative overflow-hidden font-sans">
